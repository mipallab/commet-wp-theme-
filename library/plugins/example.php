...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'      => 'Visual Composer By WPBakery',
			'slug'      => 'visual-composer-by-wpbakery',
			'source'    => get_stylesheet_directory().'/library/plugins/visual-composer-by-wpbakery-1636192165.zip',
		)
