...
$opt_name = 'commet_options';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Theme Options', 'commet' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Theme Options', 'commet' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => __( 'Ganeral Options', 'commet' ),
		'id'               => 'settings',
		'desc'             => __( 'These are Ganeral Options!', 'commet' ),
